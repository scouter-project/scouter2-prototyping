...
public class MutableListSerializer extends Serializer<MutableList<Object>> {
	...
	@Override
	public MutableList<Object> read(Kryo kryo, Input input, Class<MutableList<Object>> type) {
		final int size = input.readInt(true);
		final Object[] list = new Object[size];
		for (int i = 0; i < size; i++) {
			list[i] = kryo.readClassAndObject(input);
		}
		return Lists.mutable.with(list);
	}

	@Override
	public void write(Kryo kryo, Output output, MutableList<Object> list) {
