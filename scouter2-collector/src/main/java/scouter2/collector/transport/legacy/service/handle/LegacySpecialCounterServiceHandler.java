...
public class LegacySpecialCounterServiceHandler {
...
//	}
	 ...
	 */
	@LegacyServiceHandler(RequestCmd.ACTIVESPEED_REAL_TIME)
	public void getActiveSpeedAll(DataInputX din, DataOutputX dout, boolean login) throws IOException {
		//TODO all
