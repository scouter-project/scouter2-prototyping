...
public class MetricFileDbTest {
    ...
    public void add_and_read() throws IOException {
        ...
        //when
        db.readPeriod(pKey, TimeTypeP.REALTIME, offset, System.currentTimeMillis(), readList::add);
    ...
    public void add_and_read_cutoff_at_endMillis_condition() throws IOException {
        ...
        //when
        db.readPeriod(pKey, TimeTypeP.REALTIME, offset, now - 9000, readList::add);
    ...
    public void add_and_read_over_buffer_size_4k() throws IOException {
        ...
        //when
        db.readPeriod(pKey, TimeTypeP.REALTIME, firstOffset, now - 9000, readList::add);
