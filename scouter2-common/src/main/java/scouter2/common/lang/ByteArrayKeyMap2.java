...
import scouter2.common.legacy.util.CompareUtil;
 ...
 *
 */
public class ByteArrayKeyMap2<V> {
	...
	public ByteArrayKeyMap2(int initCapacity, float loadFactor) {
		if (initCapacity < 0)
	...
	private class Enumer implements Enumeration, ByteArrayEnumer {
		ByteArrayKeyEntry[] table = ByteArrayKeyMap2.this.table;
	...
	public void putAll(ByteArrayKeyMap2<V> other) {
	...
	public static class ByteArrayKeyEntry<V> {
		...
		public boolean equals(Object o) {
			if (!(o instanceof ByteArrayKeyMap2.ByteArrayKeyEntry))
				return false;
			ByteArrayKeyEntry e = (ByteArrayKeyEntry) o;
			return (Arrays.equals(key, e.getKey())) && (value == null ? e.getValue() == null : value.equals(e.getValue()));
		}
